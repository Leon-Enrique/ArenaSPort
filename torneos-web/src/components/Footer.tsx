...
export default function Footer() {
  return (
    <footer className="border-t border-slate-800 bg-slate-950 text-slate-400 text-xs py-10 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-2">
          <h4 className="text-white font-semibold text-xs tracking-wider uppercase flex items-center gap-1.5">
            <Gamepad2 className="w-3.5 h-3.5 text-cyan-400" /> Torneos
          </h4>
          <ul className="space-y-1.5 text-[11px]">
            <li><Link href="/" className="hover:text-purple-400 transition-colors">Ver todos los torneos</Link></li>
          </ul>
        </div>
        ...
        <div className="space-y-2">
          <h4 className="text-white font-semibold text-xs tracking-wider uppercase flex items-center gap-1.5">
            <Shield className="w-3.5 h-3.5 text-purple-400" /> Competidores
          </h4>
          <ul className="space-y-1.5 text-[11px]">
        ...
        <div className="space-y-3">
          ...
          <p className="text-[11px] text-slate-400">Únete a nuestra comunidad de Discord para organizar y coordinar tus partidas.</p>
        </div>

      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 pt-6 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between text-[11px] text-slate-400">
